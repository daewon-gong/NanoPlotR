...
The purpose of NanoPlotR is to allow visual interpretation of results from nanopore sequencing based RNA modification detection tools such as xPore (Pratanwanich et al., 2021). NanoPlotR enables fast and convenient ploting of RNA modification detection results for visualizization/interpretation of the results.
